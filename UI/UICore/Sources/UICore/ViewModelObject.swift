...
//  ref.) https://github.com/darquro/GithubViewer/blob/main/CoreModules/ViewComponents/Sources/ViewComponents/ViewModelObject.swift
//
...
public extension ViewModelObject
where Binding.ObjectWillChangePublisher == ObservableObjectPublisher, Output.ObjectWillChangePublisher == ObservableObjectPublisher {
